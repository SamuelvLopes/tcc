...
The adopted methodology included literature review, data-model design, implementation of domain services, and proof-of-concept validation with an end-to-end ISP cycle execution. The outcome provides functional evidence of feasibility, with potential gains in traceability, diagnostic standardization, and decision-making support.
