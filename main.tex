...
\mockfig{Diagrama de arquitetura lógica (Frontend React/Inertia, API Laravel, Banco relacional).}{Arquitetura da solução implementada}{fig:arquitetura-solucao}
